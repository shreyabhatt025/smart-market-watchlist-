...
export function SettingsPage() {
  ...
  return <div className="mx-auto w-full max-w-[1060px] px-5 py-8 sm:px-8 sm:py-10 lg:px-12"><div className="border-b border-border/70 pb-8"><p className="eyebrow text-primary">Desk preferences</p><h1 className="mt-3 max-w-2xl text-4xl font-bold leading-[1.08] tracking-[-.045em] sm:text-5xl lg:text-6xl">Set your signal sensitivity.</h1><p className="mt-5 max-w-xl text-sm leading-6 text-muted-foreground">Thresholds are personal. They tell the attention desk how much movement is enough to earn your time, not what you should do next.</p></div>
